...
The fastest way to connect your IDE to CoreStory is through the setup wizard in the CoreStory Dashboard at [app.corestory.ai/settings](https://app.corestory.ai/settings).
