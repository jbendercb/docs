...
**Skill files for workflows:** Each workflow playbook includes a ready-to-use SKILL.md that encodes the full workflow as plain markdown. Install location depends on your harness — Claude Code auto-loads skills from `.claude/skills/<name>/SKILL.md`; other harnesses use different conventions:
