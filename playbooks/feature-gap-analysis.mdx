...
|-------|------|---------|----------------|
| 1 | Context Loading | Establish project context and architectural understanding | Expert |
...
| 3 | Validation & Completeness | Verify the gap analysis is thorough, check for downstream effects and conflicts | Expert + Navigator |
