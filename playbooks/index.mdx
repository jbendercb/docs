...
<CardGroup cols={3}>
  ...
  <Card title="Vibe Modernization" icon="gauge-high" href="/playbooks/modernization/vibe-modernization">
    Agent-led modernization at speed, with source grounding and independent verification that hold up under audit.
  </Card>
