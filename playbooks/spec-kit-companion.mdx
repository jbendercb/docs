...
The main playbook's Agent Implementation Guides cover the major agentic harnesses end-to-end. To add Spec Kit awareness, append the matching content below to your harness's existing CoreStory configuration. The four most common harnesses are shown — if you're on a different harness, append the relevant Markdown content to wherever your harness loads workflow context (see the install conventions in the main playbook).
